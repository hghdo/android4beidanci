	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnLearn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(v.getContext(), Learn.class);
				startActivity(i);
			}
		});
		
		btnSelectCourse=(Button)this.findViewById(R.id.btn_sel_course);
		...
		Button btnUnits=(Button)findViewById(R.id.btn_units);
